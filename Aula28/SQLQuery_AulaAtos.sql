...
INSERT INTO alunos -- não é obrigatório dizer quais campos serão preenchidos se eles forem preenchidos de forma correta
VALUES ('Fabrício', '544684', 32);

INSERT INTO alunos (NOME, CPF) -- caso não sejam preenchidos todos os campos, é necessário informar os parâmetros
VALUES ('Murilo', '545646546');

---UPDATE
UPDATE ALUNOS 
SET IDADE = 27
WHERE ID = 2 -- NÃO ESQUECER DO WHERE
...
UPDATE ALUNOS 
SET CPF = '111111111'
WHERE NOME = 'Fabrício' and idade > 25 -- and é o operador lógico, assim como o or
...
DELETE FROM ALUNOS -- vai apagar tudo que tem dentro da tabela alunos pq não tem o where
