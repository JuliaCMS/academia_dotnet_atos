...
export class PessoaService {
  url = 'https://localhost:7194/api/Pessoa/pessoas';  // caminho veio da minha API get pessoas ... preciso alterar para o caminho certo quando terminar de configurar o consumo de api
